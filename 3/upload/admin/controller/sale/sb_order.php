...
class ControllerSaleSbOrder extends Controller
{
    ...
    protected function getList()
    {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('sale/sb_order', 'user_token=' . $this->session->data['user_token'] . $url, true)
        ];

        $data['invoice'] = $this->url->link('sale/sb_order/invoice', 'user_token=' . $this->session->data['user_token'], true);
        $data['shipping'] = $this->url->link('sale/sb_order/shipping', 'user_token=' . $this->session->data['user_token'], true);
        $data['add'] = $this->url->link('sale/sb_order/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['delete'] = str_replace('&amp;', '&', $this->url->link('sale/sb_order/delete', 'user_token=' . $this->session->data['user_token'] . $url, true));
        ...
        $data['sort_order'] = $this->url->link('sale/sb_order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.order_id' . $url, true);
        $data['sort_customer'] = $this->url->link('sale/sb_order', 'user_token=' . $this->session->data['user_token'] . '&sort=customer' . $url, true);
        $data['sort_total'] = $this->url->link('sale/sb_order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.total' . $url, true);
        $data['sort_date_added'] = $this->url->link('sale/sb_order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.date_added' . $url, true);
        ...
        $pagination->url = $this->url->link('sale/sb_order', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
        ...
        $data['link_send_order'] = $this->url->link('sale/sb_order/sendOrder', 'user_token=' . $this->session->data['user_token'], true);
    ...
    public function changeDelivery()
    {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validate()) {
            if (!empty($this->session->data['salesbeat_admin'])) {
                ...
                $totalSum = number_format($totalSum, 4, '.', 'value');
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('sale/order/info', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $orderId, true)
        ];
        $data['breadcrumbs'][] = [
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('sale/sb_order/changeDelivery', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $orderId, true)
        ];

        // Links
        $data['action'] = $this->url->link('sale/sb_order/changeDelivery', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $orderId, true);
        $data['cancel'] = $this->url->link('sale/order/info', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $orderId, true);
        $data['save_delivery'] = $this->url->link('sale/sb_order/saveDelivery', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $orderId, true);
