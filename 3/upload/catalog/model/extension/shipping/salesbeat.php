...
class ModelExtensionShippingSalesbeat extends Model
{
    ...
    function getQuote($address)
    {
        ...
        if (!empty($this->config->get('shipping_salesbeat_name'))) {
            $deliveryName = $this->config->get('shipping_salesbeat_name');
        } else {
    ...
    {
        require_once DIR_APPLICATION . '/controller/extension/shipping/salesbeat.php';
        $controller = new ControllerExtensionShippingSalesbeat($this->registry);
