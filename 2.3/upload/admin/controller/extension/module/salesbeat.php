...
class ControllerExtensionModuleSalesbeat extends Controller
{
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/module/salesbeat', 'token=' . $this->session->data['token'], true)
        ];

        // Links
        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/salesbeat', 'token=' . $this->session->data['token'], true);
        } else {
            $data['action'] = $this->url->link('extension/module/salesbeat', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true);
        }

        $data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=module', true);
        $data['link_sync_pay_system'] = $this->url->link('extension/module/salesbeat/syncPaySystem', 'token=' . $this->session->data['token'], true);
